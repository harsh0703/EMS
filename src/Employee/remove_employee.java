...
class remove_employee implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b1){
            try{
                conn con = new conn();//conn class object for establishing connection with the database.
                //And updating the details of the employee table of the ems database.
                String str = "delete from employee where emp_id = '"+t.getText()+"'";
                //Query for removing the details of the employee from the database.
