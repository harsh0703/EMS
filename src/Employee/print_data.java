...
class print_data implements ActionListener{
    JFrame f;
    /*Dynamic, values will be different for different employees*/
    ...
    String emp_id,name,father,address,phone,email,education,post,age,dob,aadhar; //Static, will be shown for all employees
    JButton b1,b2;
    ImageIcon icon;
    ...
    print_data(String e_id){
        ...
        id9.setLayout(null);
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("Employee/icons/print.png"));
        id9.setIcon(img);
