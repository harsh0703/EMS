...
class add_employee implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == b){
            try{
                conn cc = new conn();//Creating object of conn class to establish connection with the database
                //And store the details of the employee in the database.
                String q = "insert into employee values('"+k+"','"+a+"','"+bb+"','"+c+"','"+d+"','"+e+"','"+ff+"','"+g+"','"+h+"','"+j+"','"+i+"')";
                cc.s.executeUpdate(q);//Updating the database
